...
#SBATCH --output=/mnt/autofs/data/userdata/project0076/annalise/filtering/pipeline/logs/9-%j.out
#SBATCH --error=/mnt/autofs/data/userdata/project0076/annalise/filtering/pipeline/logs/9-%j.err
